...
public class US_004_Admin_AramaCubugu_PozitivTest extends TestBaseRapor {
    ...
    public void aramaCubuguTest() {
        ...
        // Sistem ilgili sonuçları icerdigini test edin
        String aranicakSozcuk = "Distemper";
        ...
        if (results.size() <= 0){
            Assert.assertFalse(eslesmeyenVarMi, "Sonuc bulunamadi");
        }
        ...
        Assert.assertFalse(eslesmeyenVarMi, "Eslesmeyen Sonuclar: "+eslesmeyenSonuclar);
